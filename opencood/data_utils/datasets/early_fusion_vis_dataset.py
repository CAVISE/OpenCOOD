...
class EarlyFusionVisDataset(basedataset.BaseDataset):
    ...
    def __getitem__(self, idx):
        ...
        object_bbx_center_valid = box_utils.mask_boxes_outside_range_numpy(object_bbx_center_valid, 
        ...
        processed_data_dict['ego'].update({'object_bbx_center': object_bbx_center,
